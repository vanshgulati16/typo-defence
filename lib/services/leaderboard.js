...
export const leaderboardService = {
  async updateHighScore(userId, score, username) {
    console.log('🔵 Attempting to update high score:', { userId, score, username });
    ...
    try {
      ...
      if (score > currentScore) {
        ...
        console.log('✅ High score updated successfully:', { userId, score, username });
        return true;
      } else {
